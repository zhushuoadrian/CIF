...
--AE_layers=256,128,64 --n_blocks=5 --num_thread=8 --corpus=MSP \
...
--name=CIF_MMIN_MSP --suffix=block_{n_blocks}_run_{gpu_ids}_{run_idx} --has_test \
--pretrained_path='checkpoints/MSP_utt_self_supervise_AVL_run1'
--cvNo=$i --num_classes=4 --random_seed=2024" # 🌟 注意：这里换了 random_seed
