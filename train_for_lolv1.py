...
if __name__ == '__main__':
    ...
    if setting['optimizer'] == 'adamw':
        optimizer = torch.optim.AdamW(network.parameters(), lr=base_lr, betas=(0.9, 0.95), weight_decay=1e-4)
    ...
    # ===================== 完全保留原来的数据集路径和加载 ==================
    train_data_dir = '/root/lanyun-tmp/data/LOLdataset/our485'
    test_data_dir = '/root/lanyun-tmp/data/LOLdataset/eval15'
