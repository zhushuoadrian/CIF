...
# 创建保存目录
save_img_root = '/root/lanyun-tmp/newnet/result_lolv2s'
...
def valid(val_loader_full, network):
    ...
    for batch in val_loader_full:
        ...
        # 取出 batch 中第一张图的文件名，并去掉后缀 (比如将 'image1.png' 变成 'image1')
...
if __name__ == '__main__':
    ...
    network.load_state_dict(torch.load('/root/lanyun-tmp/newnet/saved_models/lowlight/sfhformer_lol_strain_lolv2s_best.pth')['state_dict'])
