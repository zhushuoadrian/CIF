...
class TrainData(data.Dataset):
    def __init__(self, crop_size, train_data_dir, only_h_flip=False):
        super().__init__()
        train_list_haze = '/home/leng/data/myenv_1/data/LOLdataset/our485/low/LIST.TXT'
...
class TrainData_for_LOLv2Real(data.Dataset):
    def __init__(self, crop_size, train_data_dir, only_h_flip=False):
        super().__init__()
        train_list_haze = '/home/leng/data/myenv_1/data/LOLv2/Real_captured/Train/Low/Train.txt'
        with open(train_list_haze) as f:
            contents = f.readlines()
            haze_names = [i.strip() for i in contents]
            gt_names = [i.split('_')[0] + '.png' for i in haze_names]
...
class TrainData_for_LOLv2Synthetic(data.Dataset):
    def __init__(self, crop_size, train_data_dir, only_h_flip=False):
        super().__init__()
        train_list_haze = '/home/leng/data/myenv_1/data/LOLv2/Synthetic/Train.txt'
        with open(train_list_haze) as f:
            contents = f.readlines()
...
class TestData(data.Dataset):
    def __init__(self, local_size, val_data_dir, flag=True):
        ...
        val_list_haze = '/home/leng/data/myenv_1/data/LOLdataset/eval15/low/LIST.TXT'
...
class TestData_for_LOLv2Real(data.Dataset):
    def __init__(self, local_size, val_data_dir, flag=True):
        ...
        val_list_haze = '/home/leng/data/myenv_1/data/LOLv2/Real_captured/Test/Low/Test.txt'
        with open(val_list_haze) as f:
            contents = f.readlines()
            haze_names = [i.strip() for i in contents]
            gt_names = [i.split('_')[0] + '.png' for i in haze_names]
...
class TestData_for_LOLv2Synthetic(data.Dataset):
    def __init__(self, local_size, val_data_dir, flag=True):
        ...
        val_list_haze = '/home/leng/data/myenv_1/data/LOLv2/Synthetic/Test.txt'
        with open(val_list_haze) as f:
            contents = f.readlines()
            haze_names = [line.strip().split()[0] for line in contents]  # low图片名
            gt_names = [line.strip().split()[1] for line in contents]    # normal图片名
