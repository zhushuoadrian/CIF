...
# =========================================================================
# 🌟 代理生成器 (Anti-Hallucination Proxy) - [保持完整版]
# =========================================================================
...
# =========================================================================
# 🌟 混合方差门控 - 【消融实验版：w/o HVG (移除自适应抑制，强制 20% 保底)】
# =========================================================================
class HybridVariationalGate(nn.Module):
    ...
    def forward(self, feature, original_feat):
        ...
        # -------------------------------------------------------------
        # 🧪 【消融核心逻辑：w/o HVG】
        # 强制给出 20% 的流通量保底，验证这是否会引发级联噪声污染
        # -------------------------------------------------------------
        alpha = 0.2 + 0.8 * raw_alpha 
        
        # 动态感知缺失 (基于物理信号的有无，这是物理层面的屏蔽，不是特征层面的)
...
# =========================================================================
# 🌟 模态协调器 (Modality Coordinator) - [保持完整版]
# =========================================================================
...
# =========================================================================
# 🌟 融合分类器 - 【必须使用完整增强版 SURE-Net 架构，避免双重消融】
# =========================================================================
class OptimizedFusionClassifier(nn.Module):
    def __init__(self, input_dim, output_dim, dropout=0.3, d_state=16):
        ...
        print("✅ [Fusion] 启用完整重构架构：IGQF + Gated FFN (确保严格控制变量)。")
