...
# =========================================================================
# 🌟 残差保底门控 (Residual Variational Gate)
# =========================================================================
...
class CIFMMINModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            ...
            # 🌟 修复 MOSEI 回归任务：使用 L1Loss (MAE) 并避免 Double 报错
            if self.opt.corpus_name not in ['MOSI', 'SIMS', 'MOSEI']:
    ...
    def set_input(self, input):
        ...
        if self.isTrain:
            ...
            # 🌟 修复 MOSEI 回归任务的维度，且转化为 float 彻底根除 Double 报错
    ...
    def forward(self):
        ...
        # 🌟 修复 MOSEI：回归任务绝对不可以使用 Softmax，直接输出 logits 预测得分
        if self.opt.corpus_name not in ['MOSI', 'SIMS', 'MOSEI']:
